    ...
    <main role="main" class="container mt-3">
        ...
        <form class="mx-auto" action="form_nilai_get.php" method="GET">
            <div class="form-group row">
                ...
                <div class="col-7">
                    <input id=" name="nama" placeholder="Nama Lengkap" type="text" required="required" class="form-control">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-7">
                    <input id="nilai_tugas" placeholder="nilai_tugas" type="number" class="form-control" required="required" min="0" max="100">
                </div>
            </div>
            <div class="form-group row">
